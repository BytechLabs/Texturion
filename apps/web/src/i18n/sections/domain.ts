...
export const domainEn = {
  ...
  scheduledHoldCalendarUnverified: "Calendar sync is disconnected or has not checked in recently, so this reminder is waiting. It will send after sync is verified again.",
  ...
  scheduledPresetCustom: "Pick a time",
  scheduledPresetMonday: "Monday, 8:00am",
...
export const domainFr: Translated<typeof domainEn> = {
  ...
  scheduledHoldCalendarUnverified: "La synchronisation du calendrier est déconnectée ou n'a pas été vérifiée récemment, alors ce rappel est en attente. Il partira après une nouvelle vérification.",
  ...
  scheduledPresetCustom: "Choisir une heure",
  scheduledPresetMonday: "Lundi, 8 h",
