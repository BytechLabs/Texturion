...
import { ArrowUpRight, Loader2, MoreHorizontal, Trash2 } from "lucide-react";
 ...
 * task attachments, a delete action (creator or owner/admin), and one merged
 * activity+discussion timeline (task events + linked notes) with a note composer
 * at the bottom.
 *
...
/** The note composer pinned to the bottom of the panel. */
  ...
  const submit = () => {
    ...
    create.mutate(
      { taskId, body: trimmed },
      {
        ...
        onError: () => toast.error("Couldn't post your note."),
      },
    );
  };

  return (
    <div className="shrink-0 border-t border-app-line bg-app-white p-4">
