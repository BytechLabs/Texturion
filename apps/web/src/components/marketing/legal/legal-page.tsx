      ...
      <div className="lg:grid lg:grid-cols-[1fr_16rem] lg:gap-12">
        <article className="mx-auto w-full max-w-[68ch]">
          <header className="mb-10 border-b border-[color:var(--hairline)] pb-8">
            {/* v3 kicker (Public Sans 600, sentence case, §3), no mono. */}
            <Kicker>Legal</Kicker>
            {/* The Besley display face on the legal H1 (DESIGN-DIRECTION §3:
            ...
            <p className="mt-6 text-[13px] text-[color:var(--ink-55)]">
              Last updated{" "}
