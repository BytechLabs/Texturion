        ...
        <section aria-label="Matching conversations">
          ...
          {conversations.map((hit) => (
            <Link
              key={hit.id}
              href={`/inbox/${hit.id}`}
              className="flex items-center gap-3 border-b border-border-subtle px-4 py-3 transition-colors duration-150 ease-out hover:bg-app-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring/50"
            >
        ...
        <section aria-label="Matching contacts">
          ...
          {contacts.map((contact) => (
            <Link
              ...
              className="flex items-center justify-between gap-3 border-b border-border-subtle px-4 py-3 transition-colors duration-150 ease-out hover:bg-app-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring/50"
            >
