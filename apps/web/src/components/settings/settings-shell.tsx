...
/**
 * Left-nav settings shell (G8) — the client body of the settings layout (it
 * owns `usePathname`, so it can't live in the server layout that sets the
 * section's metadata title). Desktop (≥1024px): persistent nav + detail.
 * Mobile/tablet: the /settings index is the stacked section list; detail pages
 * take the full width with their own back link (SettingsPage).
 */
