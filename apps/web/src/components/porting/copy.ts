...
export const PORT_HONEST_WINDOW =
  "Your number keeps working with your current provider until the switch completes — usually 1–7 business days. We'll email you when it's ready.";
...
export const PORT_STATE_COPY = {
  ...
  voiceException: (reason: string | null) =>
    `Your carrier flagged something on the transfer: ${
      reason?.trim().replace(/[.!?]+$/, "") ||
      "they didn't say exactly what — check your details below"
