    ...
    <ArticlePage post={POST}>
      <ArticleLede>
        ...
        <ArticleSection id="setting-it-up" heading="Setting it up: business hours, after hours, and the compliance footnote.">
          ...
          <p>Tooling wise, your platform should do the after-hours part automatically. Loonext includes an after-hours auto-reply in your own words, sent at most once per burst of messages in a conversation so nobody gets robot-spammed, and an optional call forwarding module ($8/mo) that forwards calls to a phone you choose and automatically texts missed callers back. Plans are flat per company, not per seat, on the <ArticleLink href="/pricing">pricing page</ArticleLink>.</p>
        </ArticleSection>
