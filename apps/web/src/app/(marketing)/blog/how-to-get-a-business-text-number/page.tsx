    ...
    <ArticlePage post={POST}>
      <ArticleLede>
        ...
        <ArticleSection id="faq" heading="FAQ.">
          ...
          <p>Can customers call the number? It&apos;s a real phone number, so yes, people will dial it, and platforms handle those calls very differently, so ask before you sign up. On Loonext, an optional $8 a month call forwarding module sends calls to any phone you choose, and missed callers automatically get a text back in your own words.</p>
