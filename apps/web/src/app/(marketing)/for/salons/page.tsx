...
const CONTENT: TradeContent = {
  ...
  pricingBody:
    "Starter covers 3 people, 1 local number, and 500 texts a month, enough to confirm a full book and work a waitlist; a plain confirmation counts as one, and the composer shows the count before you send. More chairs, or a second location? Pro is $79 for up to 15 people and a second number to keep two shops separate.",
