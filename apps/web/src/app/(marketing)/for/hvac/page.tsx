...
const CONTENT: TradeContent = {
  ...
  pricingBody:
    "Starter covers 3 people, 1 local number, and 500 texts a month. A surge week will send more, and that's fine: extra texts are 3¢ each up to a cap you set, and the composer shows the count before you send. Want to split the service line from the install line? Pro is $79, covers up to 10 people, and includes a second number for exactly that.",
