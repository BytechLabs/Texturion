...
const CONTENT: TradeContent = {
  ...
  h1: (
    <>
      The leak that would have been a missed call, now{" "}
  ...
  heroPhotoId: "plumber-heater",
  heroPhotoCaption: "Water heater call, caught",
  ...
  painVisual: (
    <TradePhoto
      photoId="plumber-pipe"
      caption="Hands full on a job, nobody's free to grab a ringing phone. A shared text inbox catches the customer instead of voicemail."
    />
  ),
