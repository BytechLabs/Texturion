...
/**
 * Per-route tab title for the onboarding "business" step. The step page is a
...
export const metadata: Metadata = {
  title: EN.onboarding.tabBusinessDetails,
};

export default function BusinessStepTitleLayout({
  children,
