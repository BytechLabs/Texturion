...
// #134/D42: applyVoiceOverageToSchedulePhases retired with the module toggle
// (its only caller). The voice metered item is plan furniture now — checkout
// attaches it, change-plan swaps its tiering inline (upgrade immediately,
// downgrade in the schedule's phase 2), and the mirror pass converges it.
