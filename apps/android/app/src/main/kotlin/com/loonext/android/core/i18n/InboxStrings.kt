...
object InboxStrings : AppStrings.Section {
    override val en = mapOf(
        ...
        "inbox.inboundToastNewMessage" to "New message",
        "inbox.inboundToastLine" to "{who}: {snippet}",
        "inbox.inboundToastSentMessage" to "Sent a message",
        "inbox.inboundToastSentOne" to "Sent {noun}",
        "inbox.inboundToastSentMany" to "Sent {count} {noun}",
        "inbox.inboundToastImageOne" to "a photo",
        "inbox.inboundToastImageMany" to "photos",
        "inbox.inboundToastAudioOne" to "an audio message",
        "inbox.inboundToastAudioMany" to "audio messages",
        "inbox.inboundToastVideoOne" to "a video",
        "inbox.inboundToastVideoMany" to "videos",
        "inbox.inboundToastContactOne" to "a contact card",
        "inbox.inboundToastContactMany" to "contact cards",
        "inbox.inboundToastCalendarOne" to "a calendar invite",
        "inbox.inboundToastCalendarMany" to "calendar invites",
        "inbox.inboundToastDocumentOne" to "a PDF",
        "inbox.inboundToastDocumentMany" to "PDFs",
        "inbox.inboundToastTextOne" to "a text file",
        "inbox.inboundToastTextMany" to "text files",
        "inbox.inboundToastFileOne" to "an attachment",
        "inbox.inboundToastFileMany" to "attachments",
        "inbox.undo" to "Undo",
        ...
        "inbox.bulkResultApplied" to "{verb} {count} {thing}",
        "inbox.bulkResultCapped" to
            ". {count} more matched than one go can handle, so run it again",
        "inbox.bulkResultFailedOne" to
            ". {count} couldn't be reached and was left alone",
        "inbox.bulkResultFailedMany" to
            ". {count} couldn't be reached and were left alone",
        "inbox.bulkNounOne" to "conversation",
        "inbox.bulkNounMany" to "conversations",
        "inbox.bulkVerbMarkedReadOne" to "Marked read",
        "inbox.bulkVerbMarkedReadMany" to "Marked read",
        "inbox.bulkVerbClosedOne" to "Closed",
        "inbox.bulkVerbClosedMany" to "Closed",
        "inbox.bulkVerbMarkedSpamOne" to "Marked as spam",
        "inbox.bulkVerbMarkedSpamMany" to "Marked as spam",
        "inbox.bulkVerbAssignedOne" to "Assigned",
        "inbox.bulkVerbAssignedMany" to "Assigned",
        "inbox.bulkVerbUnassignedOne" to "Unassigned",
        "inbox.bulkVerbUnassignedMany" to "Unassigned",
    ...
    override val frCA = mapOf(
        ...
        "inbox.inboundToastNewMessage" to "Nouveau message",
        "inbox.inboundToastLine" to "{who} : {snippet}",
        "inbox.inboundToastSentMessage" to "A envoyé un message",
        "inbox.inboundToastSentOne" to "A envoyé {noun}",
        "inbox.inboundToastSentMany" to "A envoyé {count} {noun}",
        "inbox.inboundToastImageOne" to "une photo",
        "inbox.inboundToastImageMany" to "photos",
        "inbox.inboundToastAudioOne" to "un message audio",
        "inbox.inboundToastAudioMany" to "messages audio",
        "inbox.inboundToastVideoOne" to "une vidéo",
        "inbox.inboundToastVideoMany" to "vidéos",
        "inbox.inboundToastContactOne" to "une fiche de contact",
        "inbox.inboundToastContactMany" to "fiches de contact",
        "inbox.inboundToastCalendarOne" to "une invitation d'agenda",
        "inbox.inboundToastCalendarMany" to "invitations d'agenda",
        "inbox.inboundToastDocumentOne" to "un PDF",
        "inbox.inboundToastDocumentMany" to "PDF",
        "inbox.inboundToastTextOne" to "un fichier texte",
        "inbox.inboundToastTextMany" to "fichiers texte",
        "inbox.inboundToastFileOne" to "une pièce jointe",
        "inbox.inboundToastFileMany" to "pièces jointes",
        ...
        "inbox.bulkNounOne" to "conversation",
        "inbox.bulkNounMany" to "conversations",
        "inbox.bulkVerbMarkedReadOne" to "Marquée comme lue",
        "inbox.bulkVerbMarkedReadMany" to "Marquées comme lues",
        "inbox.bulkVerbClosedOne" to "Fermée",
        "inbox.bulkVerbClosedMany" to "Fermées",
        "inbox.bulkVerbMarkedSpamOne" to "Marquée comme indésirable",
        "inbox.bulkVerbMarkedSpamMany" to "Marquées comme indésirables",
        "inbox.bulkVerbAssignedOne" to "Assignée",
        "inbox.bulkVerbAssignedMany" to "Assignées",
        "inbox.bulkVerbUnassignedOne" to "Désassignée",
        "inbox.bulkVerbUnassignedMany" to "Désassignées",
