...
object DomainStrings : AppStrings.Section {
    override val en = mapOf(
        ...
        "domain.monthJanuary" to "January",
        "domain.monthFebruary" to "February",
        "domain.monthMarch" to "March",
        "domain.monthApril" to "April",
        "domain.monthMay" to "May",
        "domain.monthJune" to "June",
        "domain.monthJuly" to "July",
        "domain.monthAugust" to "August",
        "domain.monthSeptember" to "September",
        "domain.monthOctober" to "October",
        "domain.monthNovember" to "November",
        "domain.monthDecember" to "December",
        "domain.contactSince" to "Customer since {since} · {conversations}",
        "domain.contactConversationOne" to "1 conversation",
        "domain.contactConversationMany" to "{count} conversations",
    ...
    override val frCA = mapOf(
        ...
        "domain.monthJanuary" to "janvier",
        "domain.monthFebruary" to "février",
        "domain.monthMarch" to "mars",
        "domain.monthApril" to "avril",
        "domain.monthMay" to "mai",
        "domain.monthJune" to "juin",
        "domain.monthJuly" to "juillet",
        "domain.monthAugust" to "août",
        "domain.monthSeptember" to "septembre",
        "domain.monthOctober" to "octobre",
        "domain.monthNovember" to "novembre",
        "domain.monthDecember" to "décembre",
        "domain.contactSince" to "Client depuis {since} · {conversations}",
        "domain.contactConversationOne" to "1 conversation",
        "domain.contactConversationMany" to "{count} conversations",
