...
struct HoursSectionView: View {
    ...
    var body: some View {
        ...
        // #237: last, and on this screen rather than a section of its own.
        // Every card above answers "what do we send automatically, and in whose
        // words" — the away reply, the closed dates, the emergency reply. A
        // reminder is the same question with a different trigger, and the
