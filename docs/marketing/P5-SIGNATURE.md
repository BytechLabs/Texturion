...
Timestamps drawn in order from: `9:04 PM`, `6:48 AM`, `12:15 PM`, `5:31 PM`, `8:47 AM`. Matching inbox rows (real ConversationRow data): "Water heater leaking, error E110 · 9:04 PM", "No heat this morning, thermostat blank · 6:48 AM", "Can you add the back beds this week? · 12:15 PM", "You: Sorry we missed your call. Text us right here and someone will get back to you. · 5:31 PM", "Is he coming today? · 8:47 AM". All fictional-but-plausible content, no invented product stats, no fake names implying customers.

**#491:** the 5:31 PM row is a CALL, and it is deliberately the one outbound row. The field draws the moment a customer reached the business; the row shows what the inbox holds afterwards, and when that moment was a call nobody could take, what it holds is the automatic text-back. It renders with the app's own `"You: "` snippet prefix (`inbox/conversation-row.tsx`), never a marketing invention. Five customer texts was the first product surface on the site, and most of why the whole product read as a texting tool.
