...
| 5–9 | pending | Audit-driven polish WITH the VISUALS.md mandate as a standing bar every iteration: richer visuals where thin, interactive refinement, copy tightening, accessibility, Lighthouse tuning toward 100. Design-QA must judge "looks rich like top-tier SaaS, not empty" every round. |
